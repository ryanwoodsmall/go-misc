...
gobs3filesha256="e1cce9379a24e895714a412c7ddd157d2614d9edbe83a84449b6e1840b4f1226"
...
gominver="${gover#*.}"
gominver="${gominver%%.*}"
: ${gofilesha256:="d010c109cee94d80efe681eab46bdea491ac906bf46583c32e9f0dbb0bd1a594"}
godir="go${gover}"
