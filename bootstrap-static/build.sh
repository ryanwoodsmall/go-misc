...
gobs3filesha256="08f6419547563ed9e7037d12b9c8909677c72f75f62ef85887ed9dbf49b8d2dd"
...
gominver="${gover#*.}"
gominver="${gominver%%.*}"
: ${gofilesha256:="229c08b600b1446798109fae1f569228102c8473caba8104b6418cb5bc032878"}
godir="go${gover}"
