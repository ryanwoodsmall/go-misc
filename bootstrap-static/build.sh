...
gobs3filesha256="800a7ae1bff179a227b653a2f644517c800443b8b4abf3273af5e1cb7113de59"
...
gominver="${gover#*.}"
gominver="${gominver%%.*}"
: ${gofilesha256:="5a86a83a31f9fa81490b8c5420ac384fd3d95a3e71fba665c7b3f95d1dfef2b4"}
godir="go${gover}"
